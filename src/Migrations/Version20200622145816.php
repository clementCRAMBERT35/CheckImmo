 ...
 */
final class Version20200622145816 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces ADD chauffage VARCHAR(255) NOT NULL, ADD prix INT DEFAULT NULL, CHANGE anne_construction anne_construction INT DEFAULT NULL, CHANGE surface_sejour surface_sejour INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonces DROP chauffage, DROP prix, CHANGE anne_construction anne_construction INT DEFAULT NULL, CHANGE surface_sejour surface_sejour INT DEFAULT NULL');
